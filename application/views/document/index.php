<div class="main-content">
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <ol class="breadcrumb text-left text-white mt-10">
                     ...
                     <li class="active text-gray-silver"><?php echo $this->data['title'];?></li>
                  </ol>
               </div>
            </div>
         </div>
         ...
         <div class="row blog-posts">
            <div class="col-md-12">
               ...
               <?php 
                ...
                foreach($this->data['document'] as $post){
                  echo '<div class="gallery-item">';
                  echo '<article class="post clearfix mb-30 bg-lighter">';
                  echo '<div class="entry-header">';
                  echo '  <div class="post-thumb thumb">';
                  if($post->image!=''){
                    echo '    <img src="'.asset_url().$post->image.'" alt="'.$post->title.'" class="img-responsive img-fullwidth">';
                  }
                  echo '  </div>';
                  echo '  </div>';
                  ...
                  echo '      <h2 class="entry-title text-white text-uppercase m-0 mt-5 font-18"><a href="'.base_url().'tai-lieu/'.$this->uri->segment(2).'/'.$post->slug.'">'.$post->title.'</a></h2>';
                  echo '    </div>';
                  echo '  </div>';
                  ...
                  echo '<a href="'.base_url().'tai-lieu/'.$this->uri->segment(2).'/'.$post->slug.'" class="btn-read-more">Chi tiết</a>';
   ...
   <section style="text-align: center;">
      <button id='load-more' type="button" class="btn btn-lg btn-default ld-over" style="width:20%;height:50px;margin-bottom:20px;">
        <span id='info' class='<?php echo $this->uri->segment(2)?>'>Xem thêm</span>
