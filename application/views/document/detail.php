               ...
               <div class="blog-posts single-post">
                  <article class="post clearfix mb-0">
                     <div class="entry-header">
                        <div class="post-thumb thumb"> <img src="<?php echo asset_url().$this->data['document']->image?>" alt="" class="img-responsive img-fullwidth"> </div>
                     </div>
                        ...
                        <div class="col-sm-12">
                           <div class="form-group">
                              <input name="form_course" class="form-control" type="text"
                                 placeholder="Khóa học cần tư vấn">
                           </div>
                        </div>
                     </div>
                     <div class="form-group">
