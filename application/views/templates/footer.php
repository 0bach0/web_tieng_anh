         ...
         <footer id="footer" class="footer divider layer-overlay overlay-dark-9" data-bg-img="http://placehold.it/1920x1280" style="background-image: url(&quot;http://placehold.it/1920x1280&quot;);">
               ...
               <div class="row border-bottom">
                  <div class="col-sm-6 col-md-4">
                     <div class="widget dark">
                        <img class="mt-5 mb-20" alt="" src="<?php echo asset_url()?>images/logo-white-1496711450">
                        <p>15/378 Lê Duẩn, Hà Nội</p>
                        <ul class="list-inline mt-5">
                           <li class="m-0 pl-10 pr-10"><i class="fa fa-phone text-theme-color-2 mr-5"></i> <span class="text-gray">096 886 0488</span></li>
                           <li class="m-0 pl-10 pr-10"><i class="fa fa-envelope-o text-theme-color-2 mr-5"></i> <a class="text-gray" href="mailto:%20tuvan@thuyed.edu.vn">sample@gmail.com</a></li>
                           <li class="m-0 pl-10 pr-10"><i class="fa fa-globe text-theme-color-2 mr-5"></i> <a class="text-gray" href="<?php echo base_url()?>">http://google.com.vn</a></li>
                        </ul>
                     </div>
                     <div class="widget dark">
                  ...
                  <div class="col-sm-6 col-md-4">
                     <div class="widget dark">
                        ...
                        <ul class="list angle-double-right list-border">
                           ...
                           <li><a href="<?php echo base_url()?>khoa-hoc">Khóa học</a></li>
                           <li><a href="<?php echo base_url()?>lich-khai-giang">Lịch khai giảng</a></googli>
                           <li><a href="<?php echo base_url()?>tin-tuc">Tin tức</a></li>
                           <li><a href="<?php echo base_url()?>tai-lieu">Tài liệu</a></li>
                           <li><a href="<?php echo base_url()?>cam-nhan-hoc-vien">Cảm nhận học viên</a></li>
            ...
            <div class="footer-bottom bg-black-333">
               <div class="container pt-20 pb-20">
                  <div class="row">
                     <div class="col-md-6">
                        <p class="font-11 text-black-777 m-0">Copyright ©2016. All Rights Reserved</p>
                     </div>
